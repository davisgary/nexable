  ...
  return (
    <div className="min-h-screen flex flex-col text-center">
      <div className="w-full max-w-3xl mx-auto flex flex-col items-center justify-start flex-grow py-52">
        ...
        <Link href="/" className="font-medium leading-normal rounded-3xl border-2 border-primary px-4 py-2 active:bg-transparent transition-all duration-300 hover:scale-105">
          Go Back Home
        </Link>
      </div>
    </div>
